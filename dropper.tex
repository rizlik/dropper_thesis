...
\cite{schwartz-2011}. %TODO vanno elencate le categorie?  Inoltre
                      %vengono
...
Attualmente il modulo dropper implementa come strategie per scrivere
sulla memoria l'utilizzo della funzione \lstinline{read} oppure
l'utilizzo di una serie di gadget che ci consentano la scrittura 
